                    ...
                    <form role="form" action="/admin/users/update" method="post">
                        ...
                        <div class="box-body">
                            <div class="{{ $errors->has('f_name') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::text('f_name', $user->f_name, ['class' => 'form-control', 'placeholder' => 'Фамилия']) }}
                            ...
                            <div class="{{ $errors->has('s_name') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::text('s_name', $user->s_name, ['class' => 'form-control', 'placeholder' => 'Имя']) }}
                            ...
                            <div class="{{ $errors->has('t_name') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::text('t_name', $user->t_name, ['class' => 'form-control', 'placeholder' => 'Отчество']) }}
                            ...
                            <div class="{{ $errors->has('login') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::text('login', $user->login, ['class' => 'form-control', 'placeholder' => 'Логин']) }}
                                {!! $errors->first('login', '<span class="help-block">:message</label>') !!}
                            </div>

                            <div class="{{ $errors->has('password') ? 'form-group has-error' : 'form-group' }}">
                                <label for="exampleInputEmail1">Пароль (не обязательно)</label>
                            ...
                            <div class="{{ $errors->has('role_id') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::select('role_id', $user_roles, $user->role_id, ['class' => 'form-control']) }}
                            ...
                            <div class="{{ $errors->has('type_id') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::select('type_id', $user_types, $user->type_id, ['class' => 'form-control']) }}
