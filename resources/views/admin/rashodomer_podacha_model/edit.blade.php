            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Редактирование модели расходомера на подаче</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="/admin/rashodomer_podacha_model/update" method="post">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            <div class="{{ $errors->has('model') ? 'form-group has-error' : 'form-group' }}">
                                ...
                                {{ Form::text('model', $item->model, ['class' => 'form-control', 'placeholder' => 'Модель расходомера на подаче']) }}
